...
namespace FactorioAchievementPatcher
{
	...
	public static class Patches
	{
		...
		public static Patch[] Linux = [
			...
			// CommonMapInteraction::openGuiInternal
			new Patch("_ZN20CommonMapInteraction15openGuiInternalER10Controller", Offset: 0xB43A,
				Target: [
					0x48, 0x8B, 0x48, 0x20,                    // mov     rcx, [rax + 0x20]
					0x48, 0x8B, 0xB1, 0x70, 0x01, 0x00, 0x00,  // mov     rsi, [rcx + 0x170]
					0x48, 0x89, 0xf1,                          // mov     rcx, rsi
					0x48, 0xD1, 0xE9,                          // shr     rcx, 0x01
					0x48, 0x3B, 0x88, 0xE8, 0x02, 0x00, 0x00   // cmp     rcx, [rax + 0x2e8]
				],
				Replacement: [
					0x48, 0x8B, 0x48, 0x20,                    // mov     rcx, [rax + 0x20]
					0x48, 0x8B, 0xB1, 0x70, 0x01, 0x00, 0x00,  // mov     rsi, [rcx + 0x170]
